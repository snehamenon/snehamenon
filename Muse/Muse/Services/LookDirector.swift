        ...
        return [
            Look(
                ...
                steps: [
                    ...
                    TutorialStep(stepNumber: 5, title: "Define the lash line", zone: .lashLine, product: "Brown pencil liner", shadeGuidance: "Soft brown, not black, keeps it daytime.", technique: "Tightline the upper lashes and smudge slightly so the line stays invisible.", proTip: "Look down into a mirror while tightlining — it keeps the line invisible but the base of the lashes dense.", colorHex: "#5A3D2E", finish: "matte"),
                    TutorialStep(stepNumber: 6, title: "Lengthen the lashes", zone: .lashes, product: "Lengthening mascara", shadeGuidance: "Soft brown by day, black if you want more impact.", technique: "Wiggle the wand at the roots and pull up through the tips; two coats on the top lashes for length and thickness.", proTip: "Comb through with a clean spoolie between coats so they stay separated, not clumped.", colorHex: "#3A2A20", finish: "matte"),
                    TutorialStep(stepNumber: 7, title: "Finish the lips", zone: .lips, product: "Tinted balm or satin lipstick", shadeGuidance: "A your-lips-but-warmer terracotta nude.", technique: "Apply from the center and press lips together; edge definition stays soft.", proTip: "Dab a fingertip of the cream bronzer onto the lips first for a perfectly tied-together look.", colorHex: "#C97A5C", finish: "satin")
                ]
            ),
            Look(
                name: "Clean Slate",
                ...
                steps: [
                    ...
                    TutorialStep(stepNumber: 5, title: "Curl and coat the lashes", zone: .lashes, product: "Lash curler + brown mascara", shadeGuidance: "Brown keeps it soft; black if you want more definition.", technique: "Curl at the root for ten seconds, then one or two coats wiggled up through the lashes, top only.", proTip: "Heat the curler with a hairdryer for two seconds (test on your hand!) for a curl that lasts all day.", colorHex: "#4E382C", finish: "matte")
                ]
            ),
            Look(
                name: "After Dark",
                ...
                steps: [
                    ...
                    TutorialStep(stepNumber: 4, title: "Stack the lashes", zone: .lashes, product: "Volumizing black mascara (or false lashes)", shadeGuidance: "Jet black for full drama.", technique: "Two to three coats wiggled root to tip, building thickness; add an outer-corner lash cluster for extra lift.", proTip: "Let each coat dry a few seconds so the lashes build length instead of clumping together.", colorHex: "#1C1320", finish: "matte"),
                    TutorialStep(stepNumber: 5, title: "Lock the base", zone: .fullFace, product: "Long-wear foundation + setting powder", shadeGuidance: "Exact match; evening light is unforgiving of oxidized bases.", technique: "Thin layers with a damp sponge, pressed — not wiped — then powder where you crease.", proTip: "Powder first under the eyes, before concealer, to catch any late fallout.", colorHex: "#E3C3A8", finish: "satin"),
                    TutorialStep(stepNumber: 6, title: "Sculpt for low light", zone: .cheekbones, product: "Powder contour + liquid highlighter", shadeGuidance: "Cool-neutral contour; champagne highlight.", technique: "Contour just under the cheekbone, highlight only the very top — evening light exaggerates both, so use less than feels right.", proTip: "Blend contour with whatever's left on your foundation sponge for zero harsh lines.", colorHex: "#8A6A55", finish: "matte"),
                    TutorialStep(stepNumber: 7, title: "Velvet lip", zone: .lips, product: "Matte liquid lip or velvet lipstick", shadeGuidance: "Mauve-nude lets the eyes lead; deep berry if you want double drama.", technique: "Line and fill with pencil first, then one thin coat of the liquid, blotted.", proTip: "Conceal around the lip line afterward — the crisp edge is what makes it look professional.", colorHex: "#A86A7A", finish: "satin"),
                    TutorialStep(stepNumber: 8, title: "Make it survive the night", zone: .fullFace, product: "Setting spray", shadeGuidance: "Any fine-mist formula.", technique: "Three X-motion spritzes at arm's length with eyes closed; let it dry untouched.", proTip: "Spray once after base and once at the end — layered setting outlasts a single final mist.", colorHex: "#FFFFFF", finish: "dewy")
                ]
            )
        ]
    }
